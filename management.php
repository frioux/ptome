...
<?php
    if($securityManager->isPageVisible("addUser")) { ?>
     ...
     <?php
        ...
        $fieldset->addField(new Text("name", "Full Name", array("maxlength"=>50), true, true));
        $fieldset->addField(new Text("secondContact", "Second Contact", array("maxlength"=>50), false, true));
